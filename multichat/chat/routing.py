...
channel_routing = [
    ...
    # Can't go in  the include above as it's not a got a 'path' attribute to match on.

    include("chat.routing.custom_routing"),

    # A default "http.request" route is always inserted by Django at the end of the routing_list
